...
const Navbar = ({ searchTerm, setSearchTerm, onProfileClick, onLogout }) => (
    <nav className="bg-gradient-to-r from-emerald-600 via-green-600 to-teal-600 text-white px-6 py-4 shadow-xl sticky top-0 z-50 backdrop-blur-sm">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            <div className="flex justify-center sm:justify-end">
                ...
                <button
                    onClick={onLogout}
                    className="bg-red-500 text-white px-6 py-3 rounded-2xl hover:bg-red-600 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                    🚪 Logout
                </button>
            </div>
